...
public class AppBackup {
    ...
    public static double getBalanceOfManagers() throws IOException {
        ...
        while ((row = csvReader.readLine()) != null) {
            String[] data = row.split(",");
            balance = Double.parseDouble(data[managerBalanceIndex]);
            break;
        }
        return balance;
}
    
    public static void createCustomerStock(String ssn, String stockName, int shares) throws Exception{
    	if (!userExists("customer", ssn)) {
            ...
            csvWriter.append(",");
            csvWriter.append(Integer.toString(shares));
            csvWriter.append("\n");
            csvWriter.flush();
            csvWriter.close();
        }
    ...
    //whether stock exists in the market
  ...
  //whether customer holds the stock
    public static boolean stockExistsCustomer(String ssn,String name) throws IOException{
    	boolean exists = false;
        ...
        while ((row = csvReader.readLine()) != null) {
        	...
        	if (data[ssnIndex].equals(ssn)) {
        	   if (data[customerstockNameIndex].equals(name)) {
        		  exists = true;
        	   } 
        	}
        }
    ...
    public static void updateCustomerStockAttribute(String ssn, String stockName, int indexOAttribute, String newValue) throws Exception {
        ...
        while ((row = csvReader.readLine()) != null) {
            String[] data = row.split(",");
            if ((data[ssnIndex].equals(ssn)) && (data[customerstockNameIndex].equals(stockName))) {
                  userData = data;
            }
          }
    ...
    public static String getCustomerShare(String ssn,String name) throws Exception {
        if (!userExists("customer", ssn)) {
            throw new Exception("User does not exist");
        }
